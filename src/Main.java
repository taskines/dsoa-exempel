 ...
 */
        ...
        System.out.println("Potenser: "+ Recursy.pow(4,2));
      ...
      //  System.out.println(Recursy.fib(40)+" fib OPERATIONS: "+ Recursy.ops);
      //  Recursy.ops=0;

      //  System.out.println(Recursy.fastFib(40)+" fib OPERATIONS: "+ Recursy.ops);
        ...
        for (int i = 0; i < topNames.length; i++) {
            persons.add(new Person(topNames[i],i+1));
        }
